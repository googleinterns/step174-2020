...
public class PerspectiveAPIFactoryImpl implements PerspectiveAPIFactory {
   ...
   * @throws IllegalAccessException if class called from doesn't have proper access to the method to
   *     get the key (getKey)
   * @throws InvocationTargetException if the method to get the key (getKey()) itself throws an
   *     exception
   */
